...
public class Cashier {
    /**
     * Mediator class that coordinates the pay bill use case, initiated by
     * TableDisplay. Interacts directly with the table's card reader, the
     * table's receipt printer and the Bank client.
     */
    ...
    /**
     * this is the method that triggers the use case, when called by
     * TableDisplay. a Money argument is passed which is the total order amount,
     * taken by the table's ticket
     */
    public void pay(Money total) {
        ...
        // makePayment output event using card details and total follow by input
        // event
        ...
        // print the receipt which includes total amount and the authorisation
        // code. Output event.
